...
//        FrmVentaDetalle11.txtNombre_usuario.setText(lblNombre_persona.getText());
    ...
    private void initComponents() {
        ...
        jmIDevoluciones = new javax.swing.JMenu();
        ...
        jmIDevoluciones.setBackground(new java.awt.Color(204, 204, 204));
        jmIDevoluciones.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImanegesMenuBar/ventaMenu.png"))); // NOI18N
        jmIDevoluciones.setText("Venta");
        jmIDevoluciones.setToolTipText("");
        jmIDevoluciones.setAlignmentX(0.0F);
        jmIDevoluciones.setAlignmentY(0.0F);
        jmIDevoluciones.setBorderPainted(true);
        jmIDevoluciones.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jmIDevoluciones.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        jmIDevoluciones.add(JmIDevoluciones);

        menuBar.add(jmIDevoluciones);
...
//        deskPricipal.add(form);
    ...
    public static javax.swing.JMenu jmIDevoluciones;
