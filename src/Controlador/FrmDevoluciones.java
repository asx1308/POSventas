    ...
    private void btn_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RegistrarActionPerformed
        ...
        if (!txt_Venta.getText().equals("")) {
            ...
            Fdevoluciones funcion = new Fdevoluciones();
              ...
              datos.setCod_venta(Integer.parseInt(txt_Venta.getText()));
              datos.setCod_producto(Integer.parseInt(txt_Cod_Pro.getText()));
              datos.setNombre_prod(txtNombre_prod.getText());
              datos.setCantidad(Integer.parseInt(txt_Cant.getText()));
